            ...
            if (this.enemyInside(map, xe, ye, x, y)) {
                ...
                if (depth > 0) {
                    if (map.isSpace(x + 1, y)) {
                        ...
                        final int temp = this.search(maptemp, x + 1, y, xe, ye, depth - 1, alpha + 1, beta, false);
                        if (temp > max) {
                            max = temp;
                        }
                        if (this.alphabeta) {
                    ...
                    if (map.isSpace(x, y + 1)) {
                        ...
                        final int temp = this.search(maptemp, x, y + 1, xe, ye, depth - 1, alpha + 1, beta, false);
                        if (temp > max) {
                            max = temp;
                        }
                        if (this.alphabeta) {
                    ...
                    Entry entry = new Entry(map, x, y, xe, ye, depth, alpha, beta, max, hashValue, true);
            ...
            if (this.enemyInside(map, xe, ye, x, y)) {
                ...
                if (depth > 0) {
                    if (map.isSpace(xe + 1, ye)) {
                        ...
                        final int temp = this.search(maptemp, x, y, xe + 1, ye, depth - 1, alpha, beta - 1, true);
                        if (temp < min) {
                            min = temp;
                        }
                        if (this.alphabeta) {
                    ...
                    if (map.isSpace(xe, ye + 1)) {
                        ...
                        final int temp = this.search(maptemp, x, y, xe, ye + 1, depth - 1, alpha, beta - 1, true);
                        if (temp < min) {
                            min = temp;
                        }
                        if (this.alphabeta) {
                    ...
                    // tạo một đối tượng biểu diễn trạng thái hiện tại của bàn cờ
                    Entry entry = new Entry(map, x, y, xe, ye, depth, alpha, beta, min, hashValue, false);
                    // lưu nó vào bảng băm
                    transpositionTable.store(entry);
                }
                // ngược lại gọi hàm lượng giá cho node
